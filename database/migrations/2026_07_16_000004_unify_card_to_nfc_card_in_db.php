...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // 1. Update any existing 'Card' records to 'NFC Card'
        DB::statement("UPDATE payments SET payment_method = 'NFC Card' WHERE payment_method = 'Card'");

        // 2. Drop and recreate check constraint excluding 'Card'
        DB::statement("ALTER TABLE payments DROP CONSTRAINT IF EXISTS payments_payment_method_check");
        DB::statement("ALTER TABLE payments ADD CONSTRAINT payments_payment_method_check CHECK (payment_method IN ('Cash', 'Online Banking', 'E-Wallet', 'Cheque', 'NFC Card'))");

        // 3. Update create_mobile_purchase function to map 'card' to 'NFC Card'
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                if v_paid_with = 'card' or v_payment_source = 'card' then
                    ...
                    v_payment_method := 'NFC Card'; -- Unified to NFC Card
