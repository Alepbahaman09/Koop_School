...
return new class extends Migration
{
        ...
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                if v_paid_with = 'card' or v_payment_source = 'card' then
                    ...
                    v_payment_method := 'NFC Card'; -- Mapped to NFC Card for constraint compatibility
                    ...
                    v_payment_method := 'Cash'; -- Mapped to Cash for constraint compatibility
                end if;
    ...
    {
        // No down migration needed since we're just restoring the original mapping if rolled back (already handled by payment constraint rollback)
    }
};
